			...
			<td width="602" valign="top" bgcolor="#FFFFFF"><table
						...
						<td height="30" bgcolor="#EEEEEE" class="tableBorder_thin"><table
								...
								<tr>
									<td width="78%" class="word_grey">&nbsp;当前位置：<span
										class="word_darkGrey">二级分类管理 &gt; 添加二级分类 &gt;&gt;&gt;</span>
									</td>
									<td align="right">
					...
					<tr>
						<td align="center" valign="top">
							...
							<s:form action="SecondCategoryAction_add.do" namespace="/manager" method="post" onsubmit="return checkForm(this)">
								<table width="63%" border="0" cellpadding="0" cellspacing="0"
									bordercolor="#FFFFFF" bordercolordark="#D2E3E6"
									bordercolorlight="#FFFFFF">
									<tr align="center">
										<td width="27%" height="30" align="left" style="padding:5px;">二级分类名称：</td>
										<td width="73%" align="left">
											<input name="secondCategoryName" size="25">
										</td>
									<tr>
										<td height="30" align="left" style="padding:5px;">所属一级分类：</td>
										<td align="left">
									...
									<tr>
										...
										<td>
											...
											<input type="button" class="btn_grey" value="返回" onclick="javascript:window.location.href='${pageContext.request.contextPath }/manager/SecondCategoryAction_index.do' " />&nbsp;
										</td>
									</tr>
								</table>
							</s:form>
