...
<script type="text/javascript">
	function check(form) {
		...
		//alert(categoryName);
		if (form.BannerOne.value == "") {
			alert("请输入bannerOne!");
			form.BannerOne.focus();
			return;
		}
		if (confirm("确定要添加吗？")) {
			form.submit();
...
<body>
						...
						<td align="center" valign="top">
							<table width="96%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="15%">
										<a class="add_banner">添加banner</a>
									</td>
								</tr>
							</table>
							<s:form action="BannersAction_delete.do" namespace="/manager" method="post" id="bannersForm">
								<table width="96%" border="1" cellpadding="0" cellspacing="0"
									...
									<tr align="center" bgcolor="#A8D8FC">
										...
										<td width="40%" bgcolor="#B2D6F1">banner</td>
										<td width="40%" bgcolor="#B2D6F1">link</td>										
										<td width="10%" bgcolor="#B2D6F1">选项</td>
									</tr>
									<s:iterator id="ban"  value="bannerList"   status="sta">
									<tr align="center">
										
										<td><s:property  value="#sta.index+1"/></td>
										<td><s:property  value="BannerOne" /></td>
										<td><s:property  value="link" /></td>
										<td><input type="checkbox" name="delIdArray"  value=<s:property  value="BannerId" /> /></td>
								...
								<table width="94%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="40%" align="right">
											...
											onClick="CheckAll(bannersForm.delIdArray,bannersForm.checkbox)">
											[全选/反选] 
											[<a style="color:red;cursor:hand;"
												onClick="checkdel(bannersForm.delIdArray,bannersForm)">删除</a>]
											<div id="ch">
								...
								<table>
									<%
										...
										String urlPath=request.getContextPath()+"/manager/BannersAction_index.do";
									...
									<tr>
							             ...
							             <%}else{ %>
								             <td width="9%" align="center"><a href="#" onClick="gotopage('<%=urlPath %>','start','bannersForm')">首页&nbsp;|</a></td>
								             <td width="12%" align="center"><a href="#" onClick="gotopage('<%=urlPath %>','prev','bannersForm')">上一页&nbsp;|</a></td>
							             <%} %>
							             <%if(pageBean.getLastPage()){ %>
											 <td width="12%" align="center">下一页&nbsp;|</td>
								             <td width="8%" align="center">末页</td>
							             <%}else{ %>
								             <td width="12%" align="center"><a href="#" onClick="gotopage('<%=urlPath %>','next','bannersForm')">下一页&nbsp;|</a></td>
								             <td width="8%" align="center"><a href="#" onClick="gotopage('<%=urlPath %>','end','bannersForm')">末页</a></td>
							             <%} %>
							             ...
							             <a href="#" onClick="gotopage('','go','bannersForm')">确定</a></td>
    ...
    <div class="total_add" >
        <div class="denglu1">
            <p class="login_head1" >添加banner</p>
            <div class="clear1"></div>
            
				<form action="BannersAction_add.do" method="post" id="bannersForm_add">
					<table height="77" border="0" cellpadding="0" cellspacing="0">
						<tr>
							
							<td width="167" height="30" align="right">bannerOne：</td>
								<td  width="167" class="entry">
								<input id="BannerOne" name="BannerOne" type="text" size="25">
							</td>
						</tr>
						<tr>
							
							<td width="167" height="30" align="right">link：</td>
								<td  width="167" class="entry">
								<input id="link" name="link" type="text" size="25">
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input type="button"class="btn_grey" value="保存" onclick="check(bannersForm_add)" /> &nbsp; 
